			...
			<h3>Supplier Company Details</h3>	
				<table style="float: right">
					<tbody class="search-body">
						<tr>
							<td><input type="text" id="companyDetailsSearchId" placeholder="Search and Filter" class="search-input"/></td>
							<td><button onclick="loadCompanyDetailsTable()" class="search-btn">Search</button></td>
						</tr>
					</tbody>
				</table>
			</div>

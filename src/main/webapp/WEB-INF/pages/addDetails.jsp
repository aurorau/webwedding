			...
			<h3>Add Details</h3>	
				<table style="float: right">
					<tbody class="search-body">
						<tr>
							<td><input type="text" id="addDetailsSearchId" placeholder="Search and Filter" class="search-input"/></td>
							<td><button onclick="loadAddDetailsTable()" class="search-btn">Search</button></td>
						</tr>
					</tbody>
				</table>
			</div>
